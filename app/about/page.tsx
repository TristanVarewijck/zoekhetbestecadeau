    ...
    <SectionLayout bgColor="white">
      ...
      <div className="flex justify-center w-full mt-3">
        <div className="max-w-[700px] w-full flex flex-col md:flex-row justify-between gap-4">
          <p>
            <b>zoekhetbestecadeau</b> is jouw ultieme gids in de wereld van
            geschenken, waar we je helpen om de perfecte verrassing te vinden
            voor je dierbaren. We begrijpen dat het soms lastig kan zijn om het
            juiste cadeau te vinden, dus hebben we het zoeken naar dat ene
            speciale item leuk en moeiteloos gemaakt!
          </p>

          <p>
            Wij zijn gepassioneerd over het creëren van onvergetelijke
            herinneringen met doordachte cadeaus. We weten dat iedereen uniek
            is, met zijn eigen smaak en stijl. Daarom bieden we een uitgebreide
            selectie aan cadeau-opties, zodat je altijd iets vindt dat perfect
